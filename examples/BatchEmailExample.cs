...
/// <summary>
/// Batch email sending example based on CSharpSDK.tsx documentation
/// </summary>
public class BatchEmailExample
{
    public static async Task RunExample(string[] args)
    {
        Console.WriteLine("📦 Batch Email Example");
        Console.WriteLine("=======================\n");
        ...
        try
        {
            ...
            var emails = new[]
            {
                new Email.Builder()
                    ...
                    .To(new Address(toEmailList[0]))
                    .Subject("Email 1")
                    .TextContent("First email content.")
                    .Build(),
                new Email.Builder()
                    .From(new Address(fromEmail))
                    .To(new Address(toEmailList.Count > 1 ? toEmailList[1] : "user2@example.com"))
                    .Subject("Email 2")
